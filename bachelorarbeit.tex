...
\item[\anfl{kpi}] \textbf{Freie Analyse der Liquiditätssituation} \newline
...
Zum besseren Verständnis des Ziels der Erweiterung werden die Hauptanwendungsfälle im folgenden näher beschrieben.

\useCase{A}{

\useCaseEntry{Ziel}{Das Ziel des UseCase}
\useCaseEntry{Vorbedingung}{Die Vorbedingung des UseCase}
\useCaseEntry{Nachbedingung: Erfolg}{Die Nachbedingung (A) des UseCase}
\useCaseEntry{Nachbedingung: Fehlschlag}{Die Nachbedingung (B) des UseCase}
\useCaseEntry{Aktuere}{Die Akteure des UseCase}
\useCaseEntry{Auslösendes Ereignis}{Das auslösende Ereignis}

\textbf{Beschreibung}
\begin{seToplist}{ x 1 x }
\vspace*{-4mm}
\useCaseItem{1}{Beschreibung des Anwendungsfalls}
\useCaseItem{2}{Weitere Beschreibung des Anwendungsfalls}
\end{seToplist}
