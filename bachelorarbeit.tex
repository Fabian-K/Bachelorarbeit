...
\begin{lstlisting}[language=ActionScript, label={listing:orchestrierung:webservices}, caption={Beispielhafter Ablauf der Orchestrierung von Webservices}]
...
\begin{lstlisting}[language=ActionScript, label={listing:deserialisierung}, caption={Deserialisierung des XML-Format in die interne Objektstruktur}]
...
\begin{lstlisting}[language=Java, label={listing:servlet}, caption={Proxy-Servlet zur Umgehung der Cross-Domin Request Beschränkungen}]
import java.io.*;
import java.net.*;
