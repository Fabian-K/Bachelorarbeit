...
%TODO Pagnia fragen, wie Plural abkürzen?! hier so ok, oder ausschreiben?! -> Marker setzen
...
\caption{[TODO] [TODO Referenziereun!] \label{fig:flex_sandbox}}
\end{figure}
...
\caption{TODO\label{fig:einstellung}}
\end{figure}
...
\caption{TODO\label{fig:umsetzung_dashboard}}
\end{figure}
