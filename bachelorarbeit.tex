...
\caption{[TODO]\label{fig:umsetzung_universe}}
\end{figure}
...
\caption{[TODO]\label{fig:umsetzung_webservice}}
\end{figure}
...
Für den Datenaustausch sind zwei Wege notwendig. Zum einen müssen aus Xcelsius Parameter für die Selektion entgegengenommen werden, zum anderen muss das Ergebnis der Orchestrierung nach Xcelsius zurückgeschrieben werden.

\end{seToplist}


Für diese Bereiche wurde in einem ersten Schritt die grundlegenden Klassen und ihre Assotiationen zueinander identifiziert. Das entsprechende Klassendiagramm der Analysephase ist in Abbildung [TODO] dargestellt.
