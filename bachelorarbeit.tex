...
%TODO Einbindung checken und Titel festlegen
\includegraphics[width=15cm]{images/in-memory-row-column.png}
\caption{TODO\label{fig:vergleich_spalte_zeile}}
\end{figure}
...
\caption{TODO\label{fig:liquigruppe_hierarchie}}
\end{figure}
...
\caption{[TODO] \label{fig:laufzeitband}}
\end{figure}
...
\caption{[TODO] \label{fig:universe_abstraktion}}
\end{figure}
...
Für diese Verbindung müssen in den Einstellugnen dann einige erforderliche Bindings, siehe dazu \vref{sec:xcelsius_binding}, festgelegt werden. Erforderlich sind hierbei der Nutzer mit entsprechendem Passwort für die Authentifizierung, und die URL, unter der das SAP LRM erreichbar ist.
