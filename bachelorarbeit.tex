...
\addcontentsline{lol}{section}{Eintrag}


\begin{lstlisting}[language=Java,caption={Proxy-Servlet zur Umgehung der Cross-Domain-Request Beschränkungen\label{listing:servlet}}]
import java.io.*;
import java.net.*;
