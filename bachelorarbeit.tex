...
Im Rahmen dieser Bachelorarbeit wird ein Konzept entwickelt, mit dem weitere Anwendungen die Ergebnisse der Berechnungskomponente einbinden und weiterverarbeiten können. Das Konzept beruht dabei auf der Konsumierung und anschließenden Orchestrierung von Webservices. Durch einen modularen Aufbau ist es einfach erweiterbar und leicht wartbar. Mit dem Konzept ist eine flexiblere Nutzung des SAP LRM bezüglich der Auswertung und Weiterverarbeitung möglich.

Des Weiteren wird dieses Konzept für BusinessObjects Xcelsius, eine Anwendung zur Erstellung von interaktiven Dashboards, umgesetzt. Dadurch wird zum einen die Funktionsfähigkeit des Konzeptes sichergestellt. Zum anderen bietet sich für das SAP LRM eine neue Möglichkeit zur Visualisierung und Verarbeitung von Daten des Liquiditätsrisikomanagemnts. Es ist erstmals möglich, das Liquiditätsrisikomanagement in die Gesamtbanksteuerung einzubinden.
...
\todonum{Xcelsius mit Abkürzung in gesamter Arbeit erstetzen}
