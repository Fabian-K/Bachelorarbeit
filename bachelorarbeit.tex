...
%TODO CashFlow generell ersetzen + schreibweise checken (Cash-Flow ?!)?!
\includegraphics[width=15cm]{images/OberonUI.png}
\caption{Darstellung eines CashFlow-Eintrags mit dem Oberon-Framework\label{fig:oberon}}
\end{figure}

%TODO generell Plugin als Plug-In ?!
...
An die Erweiterung wurden in der Spezifikation in \vref{sec:anforderungen} einige funktionale und nicht-funktionale Anforderungen gestellt. Um diese zu überprüfen wurde ein Beispieldashboard, das in \vref{} zu sehen ist, erstellt.

%TODO Dashboard einbinden
