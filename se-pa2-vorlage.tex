...
\end{table}
\footnotetext{\seCite{vgl.}{S.12}{test}}
...
\section{Zitat}
Einfaches Zitat in Fußnote.\seFootcite{vgl.}{S.4}{test} Komplexer Zitierter Text in Fußnote.\footnote{\seCite{vgl.}{S.7}{test} \seCite{und}{S.4}{test}}
